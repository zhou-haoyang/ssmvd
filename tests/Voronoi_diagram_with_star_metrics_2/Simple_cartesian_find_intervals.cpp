...
{
protected:
  Voronoi_diagram_with_star_metrics_2_test()
      : Voronoi_diagram_with_star_metrics_2(boundary) {}
  Polygon_2 boundary;
  ...
  std::vector<FT> find_interval_endpoints(Site_const_iterator site,
  ...
  void check_interval_endpoints(Site_const_iterator site,
                                const Parametric_line_2& segment,
                                FT tmin,
                                std::optional<FT> tmax = std::nullopt) {
    Intervals res;

#ifndef SSM_VORONOI_DIAGRAM_POLYGON_2_VERTEX_PAIR_CIRCULATOR_H
#define SSM_VORONOI_DIAGRAM_POLYGON_2_VERTEX_PAIR_CIRCULATOR_H

#include <CGAL/circulator.h>

namespace CGAL {
template <class Metric_vertex_circulator>
class Polygon_2_vertex_pair_circulator {
   public:
...
#endif  // SSM_VORONOI_DIAGRAM_POLYGON_2_VERTEX_PAIR_CIRCULATOR_H

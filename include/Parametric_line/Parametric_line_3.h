 ...
 */
template <class R_> struct Parametric_line_3
{
public:
  using R = R_;
  ...
  Parametric_line_3(Point_3 p = {}, Vector_3 d = {})
      : m_p(std::move(p))
      , m_d(std::move(d)) {}
 ...
 */
template <class K_, class T_ = double> class Parametric_line_traits_3
{
public:
  using K = K_;
  ...
  struct Construct_parametric_line_3
  {
    ...
    Parametric_line_3 operator()(const Point_3& p0, const Point_3& p1) const { return Parametric_line_3(p0, p1 - p0); }
  };
  ...
  struct Intersect_3 : public K::Intersect_3
  {
    ...
    std::optional<std::pair<FT, FT>>
    operator()(const Parametric_line_3& l0, const Parametric_line_3& l1, bool coplanar = false) {

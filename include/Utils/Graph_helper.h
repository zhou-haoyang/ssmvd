...
template <class Kernel> class Projection_traits_with_scalar_product_3 : public Kernel
{
public:
...
void insert_halfedge_loop(typename boost::graph_traits<G>::halfedge_descriptor hd,
                          G& graph,
                          const VPM& vpm,
                          const GT& traits) {
...
connect_vertices(typename boost::graph_traits<G>::vertex_descriptor v0,
                 typename boost::graph_traits<G>::vertex_descriptor v1,
                 G& graph,
                 const VPM& vpm,
                 const GT& gt0,
                 const GT& gt1) {
...
template <class G, class GT, class VPM>
typename boost::graph_traits<G>::halfedge_descriptor
connect_vertices_3(typename boost::graph_traits<G>::vertex_descriptor v0,
                   typename boost::graph_traits<G>::vertex_descriptor v1,
                   G& graph,
                   const typename GT::Vector_3& n0,
                   const typename GT::Vector_3& n1,
                   const VPM& vpm,
                   const GT& traits = {}) {
...
template <class G, class GT, class VPM>
typename boost::graph_traits<G>::halfedge_descriptor
connect_vertices_2(typename boost::graph_traits<G>::vertex_descriptor v0,
                   typename boost::graph_traits<G>::vertex_descriptor v1,
                   G& graph,
                   const VPM& vpm,
                   const GT& traits = {}) {
